...
<head>
    ...
    <title>SISUMAKER (Sistem Surat Masuk Keluar)| Log in</title>
...
<body class="hold-transition login-page" style="background-image : url('{{asset("image/bg-login.jpg")}}');background-size: cover;  ">
    <div class="login-box">
        <div class="login-logo">
            <img src="{{asset('image/logo.png')}}" alt="" width="350px">
        </div>
        <h3 class="text-center" style="color : white">Sistem Surat Masuk Keluar</h3>
        <!-- /.login-logo -->
